...
--*/
{
...
#ifdef CDAS2_CHANGES
    case IOCTL_BULKUSB_GET_CONFIG_DESCRIPTOR_CDAS1:
    {
        ULONG length;
    ...
    case IOCTL_BULKUSB_GET_CONFIG_DESCRIPTOR_CDAS2:
    {
        ULONG length;
...
#ifdef CDAS2_CHANGES
    case IOCTL_BULKUSB_RESET_DEVICE_CDAS1:
        
        ntStatus = BulkUsb_ResetDevice(DeviceObject);

        break;

    case IOCTL_BULKUSB_RESET_DEVICE_CDAS2:
        
        ntStatus = BulkUsb_ResetDevice(DeviceObject);

        break;

    case IOCTL_BULKUSB_RESET_PIPE_CDAS1:
    {
        PFILE_OBJECT           fileObject;
        PUSBD_PIPE_INFORMATION pipe;
    ...
    case IOCTL_BULKUSB_RESET_PIPE_CDAS2:
    {
        PFILE_OBJECT           fileObject;
        PUSBD_PIPE_INFORMATION pipe;
